...
function horizontalScroller(){
  ...
  // let wordpressWrapper = document.querySelector(".sticky-wrapper") // may need this because WP wrapper isn't 100vw? thought I could use sticky-wrapper as proxy for custom-html.embed-container div but not working
